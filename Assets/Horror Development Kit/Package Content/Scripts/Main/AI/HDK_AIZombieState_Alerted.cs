...
public class HDK_AIZombieState_Alerted : HDK_AIZombieState
{
	// Inspector Assigned
	...
	public override AIStateType OnUpdate()
	{
        ...
        if (player)
        {
            if (!player.GetComponent<HDK_Hiding>().Hiding)
            {
		...
		{
			angle = HDK_AIState.FindSignedAngle (_zombieStateMachine.transform.forward, 
