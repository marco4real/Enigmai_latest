...
public class GameSceneManager : MonoBehaviour 
{
	...
	// Private
	private Dictionary< int, HDK_AIStateMachine>	_stateMachines	=	new Dictionary<int, HDK_AIStateMachine>();
	...
	//			the supplied key
	// --------------------------------------------------------------------
	public void RegisterAIStateMachine( int key, HDK_AIStateMachine stateMachine )
	{
	...
	// --------------------------------------------------------------------
	public HDK_AIStateMachine GetAIStateMachine( int key )
	{
        HDK_AIStateMachine machine = null;
